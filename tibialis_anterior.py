...
class FootDynamics:
    ...
    def get_TA_force(muscle_model):     # FTA is the muscle force of the tibialis anterior. FTA = FCE + FPE + FPD 
...
if __name__ == '__main__':  
    ...
    def activation():
        ...
        activation_sol = solve_ivp(f, [0, 0.3], [0.3], max_step=.01, rtol=1e-5, atol=1e-8) #I don't know what the initial value should be
            
    return (activation_sol.t, activation_sol.y.T)
    ...
    activation_regression_model = get_activation_regression(activation_values[0,:], activation_values[1,:] )
    ...
    TA_force = muscle.get_force(total_length, sol.y.T)
